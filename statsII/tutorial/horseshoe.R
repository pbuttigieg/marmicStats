...
# plot the abundance along a gradient in the order of the samples. Plot from slide 9.
...
# scatterplot the abundances. Plot from slide 10.
plot3d(sp1,sp2,sp3,col="red", size=3)

# check which are linearly related and which are not
plot(sp1,sp2)
plot(sp2,sp3)
